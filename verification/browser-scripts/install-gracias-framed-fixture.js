async () => {
 const v=document.createElement('video');v.src='/references/0000.mp4';v.muted=true;v.loop=true;v.playsInline=true;await v.play();
 ...
 return 'Recorded Gracias camera fixture: full-resolution source, crop x620 y230 w760 h820, no generated motion';
}
